...
<body>
	...
	<div class="container" style="background-color: #FFFFFF; border: 3px solid #00D2CF; border-radius: 30px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.6); padding: 20px;">
		<div class="col-lg-12">
					<h3 align="center"><strong>SRN REPORT - DATE</strong></h3>
	
	<form  action="ViewSRNreportDate.php" method="POST" onSubmit="return validateGRN()" name="Sales" enctype="multipart/form-data">
