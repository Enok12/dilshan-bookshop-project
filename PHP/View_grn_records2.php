...
{
	$id = $_GET['id'];
	$search_Query = "SELECT a.ID,a.GRN_ID,b.S_Name,c.P_Name,a.QTY,a.Status FROM grn_details a,supplier b,product c WHERE c.P_ID=a.P_ID AND b.S_ID=a.S_ID AND a.GRN_ID = '$id'";
