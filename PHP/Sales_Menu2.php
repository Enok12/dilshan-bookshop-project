...
<head>
<meta charset="utf-8">
<title>Sales Menu - Monethly</title>
...
<body>
	...
	<div class="container" style="background-color: #FFFFFF; border: 3px solid #00D2CF; border-radius: 30px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.6); padding: 20px;">
		<div class="col-lg-12">
					<h3 align="center"><strong>SALES MENU - MONTHLY</strong></h3>
	
	<form  action="View_Sales2.php" method="POST" onSubmit="return validateSales2() " name="Sales" enctype="multipart/form-data">
    	    ...
    	    <label> To :</label>
     		 <input type="date" name="To_Date" value="" placeholder="" >
