...
if(isset($_POST["query"]))
{
 ...
 $query = "
  select * FROM product a, sub_category b,grn_details c WHERE a.SU_ID = b.SU_ID and a.P_ID = c.P_ID && b.C_ID = '".$_SESSION['Category1']."' && P_Name LIKE '%".$search."%' and c.Activation_Status = 'Active'
 ";
}
else
{
 $query = "
 select * FROM product a, sub_category b,grn_details c WHERE a.SU_ID = b.SU_ID and a.P_ID = c.P_ID && b.C_ID = '".$_SESSION['Category1']."' &&  c.Activation_Status = 'Active'
 ";
}
