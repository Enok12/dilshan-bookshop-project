...
<body>
	...
	<div class="container">
			...
			<?php
			$sql = "Select * from grn where Received_Date BETWEEN '$fromdate' AND '$todate' and Status = 'R'";
			$query = mysqli_query($conn,$sql);
					...
					$sql1 = "SELECT a.QTY,a.C_P,a.S_P,b.P_Name,c.S_Name from grn_details a, product b, supplier c WHERE a.P_ID = b.P_ID AND c.S_ID = a.S_ID AND GRN_ID = '".$row["GRN"]."'";
					...
					header("refresh:0; url=ViewSRNDate.php");
					}
			?>
								</table>
			</div>
