...
<body>
	...
	<div class="container">
		...
		<h3 align="center"><strong>SUPPLIER : <?php echo $Supplier_Name?></strong></h3>
			...
			<?php
			$sql = "SELECT b.Received_Date,c.P_Name,a.QTY,a.S_P,a.C_P FROM grn_details a, grn b, product c WHERE c.P_ID=a.P_ID AND a.GRN_ID=b.GRN AND b.Received_Date BETWEEN '$fromdate' AND '$todate' AND b.Status = 'G' AND a.S_ID = '$Supplier_ID'";
