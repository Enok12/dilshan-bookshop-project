				...
				<div class="container-fluid">
					<div class="sidebar">
					  <a class="active" href="#home">CATEGORIES</a>
						<?php
	$res = mysqli_query($conn,"Select * from category order by C_ID");
	while($row = mysqli_fetch_array($res)){
		?>
		<a href="shop2.php?id=<?php echo $row["C_ID"];?>"><?php echo $row["C_Name"];?></a>
		<?php
	}
		?>
					</div>					
		...
		<div class="row">
		  ...
		  <div class="col-md-4 mx-auto">
			  ...
			  <br>
				<li class="list-inline-item">
				  <br>
				  <a href="#!" class="btn btn-info btn-rounded"><i class="fa fa-location-arrow"></i> &nbsp; Negombo</a>
				</li>
		  </div>
