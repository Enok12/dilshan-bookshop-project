...
if(isset($_GET['id'])){
	$_SESSION['Category2']=$_GET['id'];
}else{
	$_SESSION['Category2'] = "SU001";
}
?>
				...
				<div class="container-fluid">
					<div class="sidebar">
					  <a class="active" href="#home">SUB CATEGORIES</a>
						<?php
	$res = mysqli_query($conn,"Select * from sub_category where SU_ID = '".$_SESSION['Category2']."'");
	while($row = mysqli_fetch_array($res)){
		?>
		<a href="#"><?php echo $row["SU_Name"];?></a>
		<?php
	}
		?>
					</div>					
