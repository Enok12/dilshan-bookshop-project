...
• Untrace ability of Stock, Sales and Customer Invoices
Customer Perspective
• No Customization when choosing products.
• Consumes time when ordering products.
This web application will provide solutions to above mentioned problems as follows.
...
* First the file and copy the files to htdocs (Thr Full Folder itself)
* Create a Database (Any prefereable name)
* Import the sql file below
FILE WILL BE GIVEN SOON

* To the Folder of the application -----> PHP Folder -------> Search for connection.php.
  - Set the database name and Password if there is any
...
Your Name - Enok Dilshan - enokdilshan115@gmail.com

Project Link: [https://github.com/Enok12/dilshan-bookshop-project](https://github.com/Enok12/dilshan-bookshop-project)
